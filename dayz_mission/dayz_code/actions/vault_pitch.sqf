...
//--------------------------------
			...
			dayzPublishObj = [_combination,_tent,[_dir,_location],"VaultStorageLocked",_fuel,_code];
			publicVariableServer  "dayzPublishObj";

			cutText [format["You have setup your Safe. Combination is %1",_combination], "PLAIN DOWN"];
			sleep 15;
			cutText [format["You have setup your Safe. Combination is %1",_combination], "PLAIN DOWN"];
		};
